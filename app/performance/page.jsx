          ...
          {activeTab === "monitor" && (
            <>
              <div className="bg-white rounded-lg shadow-md p-4 mb-8">
                <h2 className="text-xl font-semibold mb-4">监控控制面板</h2>
              ...
              {collectedData && (
                <div className="max-w-4xl mx-auto mt-12 bg-white rounded-lg shadow-md p-6">
                  <h2 className="text-xl font-semibold mb-4">性能数据摘要</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 border rounded-md">
                      <h3 className="font-medium mb-2">关键渲染指标</h3>
                      <ul className="space-y-2 text-sm">
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {collectedData.FCP
                              ? `${(collectedData.FCP / 1000).toFixed(2)}s`
                              : "未收集"}
                          </span>
                        </li>
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {collectedData.LCP
                              ? `${(collectedData.LCP / 1000).toFixed(2)}s`
                              : "未收集"}
                          </span>
                        </li>
                        <li className="flex justify-between">
                    ...
                    <div className="p-4 border rounded-md">
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {collectedData.FID
                              ? `${(collectedData.FID / 1000).toFixed(2)}s`
                              : "未收集"}
                          </span>
                        </li>
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {collectedData.TTI
                              ? `${(collectedData.TTI / 1000).toFixed(2)}s`
                              : "未收集"}
                          </span>
                        </li>
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {collectedData.TBT
                              ? `${(collectedData.TBT / 1000).toFixed(2)}s`
                              : "未收集"}
                          </span>
                        </li>
                      </ul>
