...
/**
 * 获取所有作者信息
 * @returns {Promise<{data: Array|null, error: Error|null}>} 作者数据和可能的错误
 */
 ...
 * @returns {Promise<{data: Author|null, error:{code:string}}>} 作者数据和可能的错误
 */
 ...
 * @returns {Promise<{data: object|null, error: {code:string,message:string}}>} 创建的作者数据和可能的错误
 */
 ...
 * @returns {Promise<{data: object|null, error:{code:string,message:string}}>} 更新后的作者数据和可能的错误
 */
